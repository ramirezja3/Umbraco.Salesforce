...
# demos/v17/Umbraco.Automate.Salesforce.DemoSite) builds via ProjectReference to a sibling
...
param(
    [string]$SiteName = "Umbraco.Automate.Salesforce.PackageTestSite",
...
Write-Host "Using Umbraco.Automate.Salesforce version: $SalesforceVersion" -ForegroundColor Gray
...
<configuration>
  ...
  <packageSourceMapping>
    ...
    <packageSource key="local-salesforce">
      <package pattern="Umbraco.Automate.Salesforce*" />
    </packageSource>
...
Write-Host "Installing Umbraco.Automate (from nuget.org) and Umbraco.Automate.Salesforce (from local feed)..." -ForegroundColor Green
Push-Location $sitePath
dotnet add package Umbraco.Automate --version 17.2.0
dotnet add package Umbraco.Automate.Salesforce --version $SalesforceVersion
Pop-Location
