...
/// <summary>
/// Creates a Salesforce Lead with named fields for the common attributes — the classic "web form
/// to CRM" step (docs/dev-notes.md §11). Requires a Salesforce connection with the <c>api</c> scope.
/// </summary>
