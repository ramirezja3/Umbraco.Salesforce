...
`Umbraco.Automate` (from nuget.org) and `Umbraco.Community.Automate.Salesforce` (from the local pack output)
...
`Umbraco.Salesforce`, workflow file `publish.yml`, scoped to the `Umbraco.Community.Automate.Salesforce`
package id.
...
├── src/
│   └── Umbraco.Community.Automate.Salesforce/    # Actions, Connection, Configuration — the one NuGet package
├── tests/
│   ├── Umbraco.Community.Automate.Salesforce.Tests.Unit/
│   └── Umbraco.Community.Automate.Salesforce.Tests.Integration/
└── Umbraco.Community.Automate.Salesforce.slnx
```
